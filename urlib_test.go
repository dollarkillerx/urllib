...
func TestWx(t *testing.T) {
	code, resp, err := Get("https://qyapi.weixin.qq.com/cgi-bin/gettoken").
		Queries("corpid", "wwed88b8c04982ca75").
		Queries("corpsecret", "ioaD9fsQXm8d7tl01mznFZZRKX9Xf1yCz2mZOuJR9Qs").Byte()
	if err != nil {
		return
	}
	if code != 200 {
